...
```json
{
    "found": true,
    "table_no": "6.6",
    "table_name": "Population by race and religion and religion as a percentage of race - 1971",
    "primary_keys": [
        "Ethnic group"
    ],
    "field_keys": [
        "Number (in thousands)",
        "Religion",
        "Number (in thousands) - Religion",
        "Religion as percentage of Ethnic Group"
    ],
    "rows": [
        {
...
## Original Table [Image](../../../../data/tables/table-6/table-6-06/image-01.png)

![](../../../../data/tables/table-6/table-6-06/image-01.png)
